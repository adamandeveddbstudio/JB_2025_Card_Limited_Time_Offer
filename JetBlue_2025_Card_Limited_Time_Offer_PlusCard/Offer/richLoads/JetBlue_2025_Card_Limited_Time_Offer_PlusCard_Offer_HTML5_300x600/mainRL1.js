...
function animate() {
  ...
  tl.addLabel('frame2', 3)
    .to('#copyFrame1,#Aqcc', 0.5, { autoAlpha: 0}, 'frame2+=1')
    .to('#copy4', 1, { autoAlpha: 1,y:0, ease: Power1.easeOutIn }, 'frame2+=1.5')

  tl.addLabel('frame3', 8)
    .to('#frame3', 1, { y:-590, ease: Power1.easeInOut }, 'frame3+=0.5')
    .to('#shine1', 1, { autoAlpha: 1, x:417,y:0 }, 'frame3+=1.5');
